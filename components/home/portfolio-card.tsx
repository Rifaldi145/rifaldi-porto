...
const PortfolioCard: FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4 px-4 py-3  mb-4 relative">
        ...
        <div
          className="absolute flex gap-4 -right-24 group-hover:right-0 top-2 px-4 py-2 bg-heading rounded-l-md shadow-md transition-all ease-in-out duration-300"
          style={{ background: "#0caef3" }}
        >
          <Link
            href={url}
            target="_blank"
